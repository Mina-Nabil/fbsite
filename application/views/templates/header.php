            ...
            <div id="dl-menu" class="dl-menuwrapper">
              ...
              <ul class="dl-menu">
                ...
                <li>
                  ...
                  <ul class="dl-submenu">
                    <li><a href="<?= base_url() ?>course_dtl/2">CFA</a></li>
                    <li><a href="<?= base_url() ?>course_dtl/4">CMA</a></li>
                    <li><a href="<?= base_url() ?>course_dtl/5">IFRS Diploma</a></li>
                    <li><a href="<?= base_url() ?>course_dtl/6">Financial Modeling</a></li>
                  </ul>
                </li>
